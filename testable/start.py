...
SELECT 
    ...
    b.last_session_date,
    dhi.test_date AS last_hiv_test_date,
    dhi.hiv_test_awareness_date AS last_sensibilisation_hiv_test_date,
    ...
    dhi.condoms_reception_date AS last_condoms_reception_date,
    ...
    dhi.vbg_treatment_date AS last_vbg_treatment_date,
    dhi.gynecological_care_date AS last_gynecological_care_date,
    dhi.prep_awareness_date AS last_sensibilisation_prep_date,
    dhi.prep_reference_date AS last_reference_prep_date,
    dhi.prep_initiation_date AS last_initiation_prep_date,
...
FROM
    ...
    (SELECT 
        SUM(a.value = 'P') AS pres,
            ...
            a.date AS first_session_date,
            a.date AS last_session_date
    FROM
        (SELECT 
