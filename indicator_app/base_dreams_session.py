...
class Set_date(Enum):
   ...
   past_start_date = "2019-10-01"
   past_end_date = "2020-09-30"
...
FROM
    ...
    FROM
        dream_hivinfos dhi
    WHERE
        (dhi.test_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
            OR (dhi.condoms_reception_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
            OR (dhi.vbg_treatment_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
            OR (dhi.gynecological_care_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
            OR (dhi.prep_initiation_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
    ...
    WHERE
        dgs.date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}') UNION (SELECT 
        dm.id_patient
    FROM
        dream_member dm
    ...
    WHERE
        dga.value = 'P'
            AND dgs.date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}'
    ...
    (SELECT 
        dhi1.id_patient,
            ...
            SUM((dhi1.condoms_reception_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
                AND (dhi1.condoms_reception_date IS NOT NULL)) AS number_condoms_reception_in_the_interval,
            SUM((dhi1.test_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
                AND (dhi1.test_date IS NOT NULL)) AS number_test_date_in_the_interval,
            SUM((dhi1.vbg_treatment_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
                AND (dhi1.vbg_treatment_date IS NOT NULL)) AS number_vbg_treatment_date_in_the_interval,
            SUM((dhi1.gynecological_care_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
                AND (dhi1.gynecological_care_date IS NOT NULL)) AS number_gynecological_care_date_in_the_interval,
            SUM((dhi1.prep_initiation_date BETWEEN '{Set_date.period_start_date.value}' AND '{Set_date.period_end_date.value}')
...
FROM
    ...
    LEFT JOIN dream_group_session dgs ON dgs.id = dga.id_group_session
    WHERE
        dgs.date BETWEEN '{Set_date.master_start.value}' AND '{Set_date.master_end.value}') UNION (SELECT 
        dm.id_patient
    FROM
        dream_member dm
    LEFT JOIN patient p ON p.id = dm.id_patient
